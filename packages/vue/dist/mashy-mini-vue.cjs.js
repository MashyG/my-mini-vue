...
var reactive$1 = require('@mashy-mini-vue/reactivity/reactive');
var effect = require('@mashy-mini-vue/reactivity/effect');
...
function setupStatefulComponent(instance) {
    ...
    if (setup) {
        ...
        const setupResult = setup(reactive$1.shallowReadonly(props), {
            emit
        });
